...
namespace DentalManagerAPI.Migrations
{
    ...
    [Migration("20220603190106_fixedseederdata")]
    partial class fixedseederdata
    {
            ...
            modelBuilder.Entity("DentalManagerAPI.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Микола",
                            LastName = "Харш",
                            PhoneNumber = "0673646191"
                        },
                        new
                        {
                            Id = 2,
                            Address = "Є. Коновальця 31а",
                            DateOfBirth = new DateTime(2001, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Йосип",
                            LastName = "Горняткевич",
                            PhoneNumber = "0973656192"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            ...
                            FirstName = "Марко",
                            LastName = "Клименко",
                            PhoneNumber = "0973656196"
                        },
                        new
                        {
                            Id = 7,
                            Address = "С. Крушельницької 13",
                            DateOfBirth = new DateTime(2001, 11, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Федір",
                            LastName = "Губ'як",
                            PhoneNumber = "0973656197"
                        },
                        new
                        {
                            Id = 8,
                            ...
                            FirstName = "Юрій",
                            LastName = "Скрипник",
                            PhoneNumber = "0973656198"
                        },
                        new
                        {
                            Id = 9,
                            Address = "Б.Хмельницкого 155",
                            DateOfBirth = new DateTime(2001, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Миролюб",
                            LastName = "Кротевич",
                            PhoneNumber = "0973656199"
                        },
                        new
                        {
                            Id = 10,
                            Address = "Кульпарківська 1",
                            DateOfBirth = new DateTime(2001, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Євген",
                            LastName = "Островський",
                            PhoneNumber = "0973656119"
                        },
                        new
                        {
                            Id = 11,
                            Address = "Садова 11",
                            DateOfBirth = new DateTime(2001, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Євген",
                            LastName = "Чеховський",
                            PhoneNumber = "0973656112"
                        },
                        new
                        {
                            Id = 12,
                            Address = "Любінська 89",
                            DateOfBirth = new DateTime(2001, 11, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Федір",
                            LastName = "Кубів",
                            PhoneNumber = "0973096192"
                        },
                        new
                        {
                            Id = 13,
                            Address = "Антоновича 67",
                            DateOfBirth = new DateTime(2001, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Нестор",
                            LastName = "Дехтяренко",
                            PhoneNumber = "0913656192"
                        },
                        new
                        {
                            Id = 14,
                            Address = "Героїв УПА 44",
                            DateOfBirth = new DateTime(2001, 11, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Ілля",
                            LastName = "Герасимюк",
                            PhoneNumber = "0973678192"
                        },
                        new
                        {
                            Id = 15,
                            Address = "С. Бандери 22",
                            DateOfBirth = new DateTime(2001, 11, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Маркіян",
                            LastName = "Ковтун",
                            PhoneNumber = "0973506192"
                        });
                });
